...
public interface ApiService {
     ...
     */
    @POST("shop/biz/get")
    Observable<Account> login(@Query("account") String account,
    ...
    Observable<Room> getRoomList(@Query("bizId") String bizId,
     ...
     */
    @GET("user/order/get")
    Observable<Order> getOrderList(@Query("bizId") String bizId,
    ...
    Observable<Cancle> cancle(@Query("backId") String backId,
    ...
    Observable<CheckOrder> checkOrder(@Query("orderId") String orderId,
    ...
    Observable<BackOrder> getBackList(@Query("bizId") String bizId,
                                @Query("status") String status,
                                @Query("currentPage") String currentPage,
                                @Query("numPerPage") String numPerPage,
                                @Query("sign") String sign
    ...
    Observable<OrderDetail> getOrderDetail(@Query("orderId") String orderId,
                                     @Query("sign") String sign
    );
    ...
    Observable<CancleOrderDetail> getCancleOrderDetail(@Query("backId") String backId,
                                                 @Query("sign") String sign
    );
